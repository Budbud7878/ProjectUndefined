...
public class HeavensPillarBehaviours : MonoBehaviour
{

    public float heavensPillarDmg;
    public float heavensPillarRange;
    ...
    public void HeavensPillarAttack(Collider other)
    {
        ...
        if (enemy != null)
        {
            ...
            enemy.EnemyHealthLogic(heavensPillarDmg);
        }
        else
        {
