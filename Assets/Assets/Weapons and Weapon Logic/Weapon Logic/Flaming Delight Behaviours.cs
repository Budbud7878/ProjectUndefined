...
public class FlamingDelightBehaviours : MonoBehaviour
{

    public float flamingDelightDmg;
    public float flamingDelightRange;
    ...
    public void FlamingDelightAttack(Collider other)
    {
        ...
        if (enemy != null)
        {
            ...
            enemy.EnemyHealthLogic(flamingDelightDmg);
        }
        else
        {
