...
public class MineralCrusherBehaviours : MonoBehaviour
{

    public float mineralCrusherDmg;
    public float mineralCrusherRange;
    ...
    public void MineralCrushAttack(Collider other)
    {
        ...
        if (enemy != null)
        {
            ...
            enemy.EnemyHealthLogic(mineralCrusherDmg);
        }
        else
        {
